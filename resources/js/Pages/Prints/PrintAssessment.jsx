...
export default function PrintAssessment({ assessment, event }) {
    const printStyle = `
        @media print {
            @page {
                size: auto;
        ...
        <div className="p-2">
            ...
            <div className="border border-b-0 border-black/40 mx-auto">
                <div className="border-black/40 border-b font-open">
                    <div className="grid grid-cols-[5rem,6rem,repeat(8,1fr)] table-bordered overflow-hidden">
                        ...
                        <Columns $head $center>8</Columns>
                    </div>

                    <div className="table-bordered">
                        {
                            assessment.map((item, index) => (
                                <div key={index} className="grid grid-cols-[5rem,6rem,repeat(8,1fr)] border-t table-bordered overflow-hidden">
                                    ...
                                    <Columns $center>{item.q8}</Columns>
                                </div>
                            ))
                        }     
                    </div>
