    ...
    return (
        <>
            ...
            <div className="text-gray-700 h-screen">
                ...
                <div className="my-10 max-w-7xl h-[calc(100vh-10rem)] mx-auto grid grid-cols-12 gap-7 p-4">
                    <div className="col-span-7 flex flex-col">
                        <div className="mx-auto my-auto pb">
                            <div className="text-5xl font-bold">
                                Welcome to DSWD Davao <br />
                                Training Attendance <br />
                                Monitoring System
                                <div className="text-xl">for 4Ps Employees</div>
                            </div>
                            <div className="max-w-xl text-lg mt-4">
                                Training Attendance Monitoring System
                                for 4ps Employees in Davao Region that streamlines
                                managing and recording of attendance during
                                training sessions.
                            </div>

                            <div className="mt-10 font- find">
                                <div>Find us on</div>
                                <ul>
                                    <a
                    ...
                    <div className="col-span-5 flex flex-col pb-">
                        <Login status={status} canResetPassword={canResetPassword} />
                    </div>
                </div>
            </div>

            <Register show={showRegistration} onClose={() => setShowRegistration(false)} />
        </>
    );
}
