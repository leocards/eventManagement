import { EventRecentActivity } from "@/Components/Dashboard/RecentActivity";
    ...
    return (
        <Authenticated user={auth.user}>
            ...
            <div className="!max-w-2xl mx-auto container p-4 mt-5">
                ...
                {currentPage?.current_page !== currentPage?.last_page && (
                    <div className="mt-3 flex">
                        {loading && (
                            <div className="mx-auto text-sm font-medium p-1 px-2">
                                Loading...
                            </div>
                        )}
                        {!loading && (
                            <button
                                className="font-medium text-sm p-1 px-2 bg-gray-100 rounded ml-auto"
                                onClick={onLoadMore}
                            >
                                Load more
                            </button>
...
const ActivityCard = styled.div.attrs((props) => ({
    ...
    } px-4 border-l-4 transition duration-all p-2 cursor-default w-full`,
}))``;
