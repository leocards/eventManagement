    ...
    return (
        <div className="container p-3 mt-3">
            ...
            <div className="max-sm:overflow-x-auto">
                <div className="grid grid-cols-[3rem,4rem,repeat(12,minmax(0,1fr))] font-bold font-open mt-3 pb-2 border-b">
                ...
                <div className="overflow-y-auto pt-2 pb-1">
                    {
                        loading ? (
                            <LoadingList column={14} grid="grid-cols-[3rem,4rem,repeat(12,minmax(0,1fr))]" />
                            ...
                            consolidated?.map((item, index) => (
                                <div key={index} className="grid grid-cols-[3rem,4rem,repeat(12,minmax(0,1fr))] mb-1 rounded-md list-hover cursor-default">
