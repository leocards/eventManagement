...
export default function TopNavigation({ auth, onClickMenu = () => {} }) {
    const { url } = usePage();
                ...
                <div className="flex justify-between items-center h-16">
                    <div className="flex">
                        <div className="shrink-0 flex items-center">
                            <button onClick={onClickMenu} className="hover:bg-slate-200/40 transition duration-150 mr-4 p-2 rounded-full">
